...
public class DragDropMulScript : MonoBehaviour
{

    protected GameObject currentFather2;
    protected GameObject defaultFather2;

    private void Start()
    {
        defaultFather2 = GameObject.Find("Liste2");
        currentFather2 = defaultFather2;
        if (defaultFather2 == null)
        {
